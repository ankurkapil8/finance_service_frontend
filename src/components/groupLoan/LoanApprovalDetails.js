...
function LoanApprovalDetails(props) {
    ...
    const actionDisburseLoan = async (actionType) => {
        try {
            setisShowLoader(true);
            const data = { "id": props.location.state, "actionType": actionType, disburseDate: new Date() }
                ...
                <Row xs={1} md={2} className="g-1">
                    <Col>
                        ...
                        >
                            ...
                            <svg onClick={handlePrintMemberDetail} xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" className="bi bi-printer float-right cursar" viewBox="0 0 16 16">
                    ...
                    <Col>
                        <Card border="info" header
                            ...
                            ref={applicationRef}
                        >
                            <Card.Header className="bg-info text-center"><b>Co-Borrower Details</b><svg onClick={handlePrintApplication} xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" className="bi bi-printer float-right cursar" viewBox="0 0 16 16">
                                <path d="M2.5 8a.5.5 0 1 0 0-1 .5.5 0 0 0 0 1z" />
                                <path d="M5 1a2 2 0 0 0-2 2v2H2a2 2 0 0 0-2 2v3a2 2 0 0 0 2 2h1v1a2 2 0 0 0 2 2h6a2 2 0 0 0 2-2v-1h1a2 2 0 0 0 2-2V7a2 2 0 0 0-2-2h-1V3a2 2 0 0 0-2-2H5zM4 3a1 1 0 0 1 1-1h6a1 1 0 0 1 1 1v2H4V3zm1 5a2 2 0 0 0-2 2v1H2a1 1 0 0 1-1-1V7a1 1 0 0 1 1-1h12a1 1 0 0 1 1 1v3a1 1 0 0 1-1 1h-1v-1a2 2 0 0 0-2-2H5zm7 2v3a1 1 0 0 1-1 1H5a1 1 0 0 1-1-1v-3a1 1 0 0 1 1-1h6a1 1 0 0 1 1 1z" />
                            </svg></Card.Header>
                            <Card.Body>
